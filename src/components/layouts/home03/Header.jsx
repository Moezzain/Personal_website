                ...
                <div className="container">
                    <div className="flex-header d-flex justify-content-between align-items-center">
                        <div id="logo" className="logo">
                            <Link to="/" onClick={() => { window.location.href = "/" }} title="Logo"><img src="images/logo/Moez-logos_transparent.png" alt="images" style={{opacity: '0.9'}} data-width={150} data-height={34} data-retina="images/logo/Moez-logos_transparent.png" /></Link>
                        </div>
